%rebase layout title=None,path=path
	
	  <section id="top_section">
      <div id="simulator" class="single_post" style="height:744px;position:relative">
        <img src="images/tryit.png" style="position:absolute;right:-50px;top:68px" />
        <img src="images/iphone4-background.png" class="fancy" />
        <img id="iphone-button" class="phone-button" src="images/iphone-button.png" style="position:absolute;left:160px;bottom:26px" />
        <img id="tc-icon" class="phone-button" src="images/tc_iphone_57.png" style="position:absolute;left:40px;top:168px" />
        <img id="gc-icon" class="phone-button" src="images/great_cities_57.png" style="position:absolute;left:110px;top:168px" />
      </div>
      <div class="art" style="width:450px">
        <header class="post_head">
          ...
          <div id="top_menu" style="text-align:center">
            ...
            <span class="more_arch"><a href="browse">Browse Apps</a></span>
          </div>
        </header>
...
Feel free to follow us on Twitter and to subscribe to our RSS feed. You can also contact directly Mr Hurley, the mind behind, through an email to <a href="mailto:pier.made@gmail.com">pier.made@gmail.com</a></p>
	...
	<script>
  	$(document).ready(function() {
  	  $('.phone-button').mousedown(function() {
	    ...
	    $('#iphone-button').mouseup(function() {
	      $('iframe').animate({width:0, height:0, marginLeft:0, marginTop:0}, 300, function() {
	        $('iframe').remove();
	      });
	    });
  	});
  	...
  	function loadApp(url) {
  	  var ifr = $("<iframe src=\"" + url + "\" class=\"iframe_sim\"></iframe");
  	  $('#simulator').append(ifr);
  	  $('iframe').css({width:0, height:0, marginLeft:0, marginTop:0}).animate({
  	    width:320,
  	    height:460,
  	    marginLeft:-186,
  	    marginTop:-216
